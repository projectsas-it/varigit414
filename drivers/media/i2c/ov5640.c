...
struct ov5640_dev {
	...
	const struct ov5640_mode_info *mode_init_data;
...
/* YUV422 UYVY VGA@30fps legacy sensor */
static const struct reg_value ov5640_legacy_init_setting_30fps_VGA[] = {
...
/* YUV422 UYVY VGA@30fps Rev. 1B sensor */
static const struct reg_value ov5640_1B_init_setting_30fps_VGA[] = {
	{0x3103, 0x11, 0, 0}, {0x3008, 0x82, 0, 5}, {0x3008, 0x42, 0, 0},
	{0x3103, 0x03, 0, 0}, {0x3630, 0x36, 0, 0},
	{0x3631, 0x0e, 0, 0}, {0x3632, 0xe2, 0, 0}, {0x3633, 0x12, 0, 0},
	{0x3621, 0xe0, 0, 0}, {0x3704, 0xa0, 0, 0}, {0x3703, 0x5a, 0, 0},
...
/* WB group */
	{0x5180, 0xff, 0, 0},
	{0x5181, 0xf2, 0, 0}, {0x5182, 0x00, 0, 0}, {0x5183, 0x14, 0, 0},
	{0x5184, 0x25, 0, 0}, {0x5185, 0x24, 0, 0}, {0x5186, 0x10, 0, 0},
	{0x5187, 0x10, 0, 0}, {0x5188, 0x10, 0, 0}, {0x5189, 0x6d, 0, 0},
	{0x518a, 0x53, 0, 0}, {0x518b, 0x90, 0, 0}, {0x518c, 0x8c, 0, 0},
	{0x518d, 0x3b, 0, 0}, {0x518e, 0x2c, 0, 0}, {0x518f, 0x59, 0, 0},
	{0x5190, 0x42, 0, 0}, {0x5191, 0xf8, 0, 0}, {0x5192, 0x04, 0, 0},
	{0x5193, 0x70, 0, 0}, {0x5194, 0xf0, 0, 0}, {0x5195, 0xf0, 0, 0},
	{0x5196, 0x03, 0, 0}, {0x5197, 0x01, 0, 0}, {0x5198, 0x04, 0, 0},
	{0x5199, 0x00, 0, 0}, {0x519a, 0x04, 0, 0}, {0x519b, 0x13, 0, 0},
	{0x519c, 0x06, 0, 0}, {0x519d, 0x9e, 0, 0}, {0x519e, 0x38, 0, 0},
/* end WB group */
	{0x5381, 0x1e, 0, 0}, {0x5382, 0x5b, 0, 0}, {0x5383, 0x08, 0, 0},
	{0x5384, 0x0a, 0, 0}, {0x5385, 0x7e, 0, 0}, {0x5386, 0x88, 0, 0},
	{0x5387, 0x7c, 0, 0}, {0x5388, 0x6c, 0, 0}, {0x5389, 0x10, 0, 0},
	...
	{0x558b, 0xf8, 0, 0},
/* LENC group */
	{0x5800, 0x2a, 0, 0}, {0x5801, 0x1a, 0, 0},
...
static const struct ov5640_mode_info ov5640_legacy_mode_init_data = {
	0, SUBSAMPLING, 640, 1896, 480, 984,
	ov5640_legacy_init_setting_30fps_VGA,
	ARRAY_SIZE(ov5640_legacy_init_setting_30fps_VGA),
	OV5640_30_FPS,
};

static const struct ov5640_mode_info ov5640_1B_mode_init_data = {
	0, SUBSAMPLING, 640, 1896, 480, 984,
	ov5640_1B_init_setting_30fps_VGA,
	ARRAY_SIZE(ov5640_1B_init_setting_30fps_VGA),
	OV5640_30_FPS,
};
...
static int ov5640_restore_mode(struct ov5640_dev *sensor)
{
	...
	ret = ov5640_load_regs(sensor, sensor->mode_init_data);
	if (ret < 0)
		return ret;
	sensor->last_mode = sensor->mode_init_data;
...
static int ov5640_probe(struct i2c_client *client)
{
	...
	/* check if legacy sensor configured */
	sensor->legacy_revision = fwnode_property_read_bool(dev_fwnode(&client->dev), "legacy-revision");
	...
	if (sensor->legacy_revision) {
		sensor->mode_init_data = &ov5640_legacy_mode_init_data;
		dev_warn(dev, "%s: legacy init settings used\n", __func__);
	}
	else
		sensor->mode_init_data = &ov5640_1B_mode_init_data;
